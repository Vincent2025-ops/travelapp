    ...
    <div className="w-full h-screen bg-white max-w-md mx-auto relative overflow-hidden flex flex-col font-sans select-none">
      ...
      {!activeTripId ? (
        ...
        <React.Fragment key="active-trip-view">
          ...
          {/* Conditionally render bottom navigation bar - Hide when map view is active */}
          {activeTab !== 'map' && (
            <div className="absolute bottom-6 left-6 right-6 h-16 bg-white rounded-[2.5rem] shadow-2xl flex justify-between items-center px-6 z-30 border border-gray-50 transition-all duration-300">
